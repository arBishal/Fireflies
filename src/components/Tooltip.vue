...
<template>
  <div class="relative inline-block" @mouseenter="showTooltip" @mouseleave="hideTooltip" @click="hideTooltip">
    ...
    >
      <div
        v-if="isVisible"
        :class="['absolute left-1/2 -translate-x-1/2 z-50 px-2 py-1 text-xs text-neutral-100 bg-black/50 rounded-full whitespace-nowrap pointer-events-none', positionClasses]"
      >
        {{ text }}
      </div>
    </Transition>
